...
namespace Horizon
{
	struct CORE_MODULE_API HSystemTimer
	{
		/**
...
#define H_TICKS_PASSED(A, B)  ((Sint32)((B) - (A)) <= 0)
		  ...
		  */
		static uint64 GetPerformanceCounter(void);
		 ...
		 */
		static uint64 GetPerformanceFrequency(void);
		 ...
		 */
		  ...
		  */
		   ...
		   */
			...
			* \sa SDL_AddTimer
			*/
			//bool SDLCALL SDL_RemoveTimer(SDL_TimerID id);
	};
}
