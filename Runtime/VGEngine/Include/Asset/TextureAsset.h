...
namespace VisionGal
{
    ...
    /// Image file format
    enum class ImageFileFormat : uint8
    {
        /// Unknown format
        UNKNOWN = 0,
    ...
    struct TextureAsset : public VGAsset
    {
        ...
        //   HCOMPRESS_FORMAT CompressFormat;
        ...
        TextureAsset()
            : 
            VGAsset("Texture"),
            FileFormat(ImageFileFormat::UNKNOWN), 
        ...
        std::function<void()> FreeCallback = nullptr;
    };


    class VG_ENGINE_API TextureAssetLoader : public IAssetLoader
    {
    public:
